    ...
    API.addTasksSet({
	 ...
	 inelligible: [{
        ...
        [{ 
            ...
            type:'redirect', name:'redirecting', url: `https://qualtricsxmkl3hyj2vp.qualtrics.com/jfe/form/SV_7PLTkuDY3QqjGf4?sessionID=${sessionID}`
        }],
...
define(['pipAPI'], function(pipAPI) {
    ...
    API.addSequence([
        ...
        { type: 'post', path: ['$isTouch', 'GenSet', 'MascLabels', 'FemLabels'] },
